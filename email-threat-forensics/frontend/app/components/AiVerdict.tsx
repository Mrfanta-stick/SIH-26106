    ...
    <div className="rounded-2xl bg-gradient-to-r from-rose-950/30 via-[#12151c]/80 to-purple-950/20 backdrop-blur-xl border border-rose-500/30 p-6 shadow-2xl shadow-rose-950/30 relative overflow-hidden">
      ...
      <div className="mt-4 space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
          ...
          <div className="p-3 rounded-xl bg-[#08090c]/60 border border-white/5 text-xs space-y-1"><span className="text-[10px] uppercase font-mono text-slate-400 block">Pipeline Scope</span><span className="text-cyan-300 font-semibold">Ingest → hops → auth/GeoIP → URLs → attachments/graph → custody</span></div>
        </div>
      </div>
    </div>
  );
